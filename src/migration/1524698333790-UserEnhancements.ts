...
/**
 * Added indicies for User entities
 */
export class UserEnhancements1524698333790 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user_email" DROP ` +
        `CONSTRAINT "PK_f930684cc74d7b3eeea8c686873"`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user_email" ALTER COLUMN ` +
        `"lEmail" TYPE character varying(255)`
    );
    await queryRunner.query(
      `ALTER TABLE "user_email" ADD ` +
        `CONSTRAINT "PK_f930684cc74d7b3eeea8c686873" PRIMARY KEY ("lEmail")`
